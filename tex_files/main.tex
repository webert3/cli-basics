...
% Another useful control signal is \textbf{crtl+z}.  This send the \textit{suspend} signal to the operating system, stopping the foreground process from running and giving control back to the shell. This is useful for temporally pausing a process, running some commands, then restoring it as either a background or foreground process. \textit{More on this later...
